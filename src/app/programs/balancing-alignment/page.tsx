...
import {
  ...
  learningOutcomes,
} from '@/constants/programs/balancingAlignment';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';

const BalancingAlignment = () => {
  return (
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <h1 className='text-4xl lg:text-5xl font-bold mb-6'>
                Balancing And Alignment Course
              </h1>

              <p className='text-xl text-primary-foreground/90 mb-8 leading-relaxed'>
                Master the art of precision balancing and alignment for rotating
                equipment. Learn to use advanced equipment and techniques to
                eliminate vibration problems and optimize machinery performance.
              </p>
          ...
          <div className='grid lg:grid-cols-2 gap-12'>
            <div>
              ...
              <p className='text-lg text-muted-foreground leading-relaxed'>
                ...
                equipment, perform precision operations, and troubleshoot
                vibration problems. This certification enhances equipment
                reliability and reduces maintenance costs through proper
                balancing and alignment practices.
              </p>
            </div>
            <Card className='p-8'>
              <CardHeader>
        ...
        <Card className='bg-gradient-to-r from-primary to-primary/80 p-12 text-center text-primary-foreground'>
          <CardContent>
            <h2 className='text-3xl font-bold mb-4'>
              Master Precision Maintenance
            </h2>
            <p className='text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto'>
              Join thousands of professionals who have mastered balancing and
              alignment techniques and are delivering superior equipment
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <Link href='/pricing'>
                ...
                >
                  Enroll in Balancing & Alignment Course
                </Button>
              </Link>
              <Link href='/contact'>
                <Button
...
export default BalancingAlignment;

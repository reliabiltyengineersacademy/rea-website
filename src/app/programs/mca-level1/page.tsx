...
import {
  ...
  learningOutcomes,
} from '@/constants/programs/mcaLevel1';
            ...
            <div>
              <div className='inline-flex items-center bg-primary-foreground/20 rounded-full px-4 py-2 mb-6'>
                ...
                <span className='text-sm font-medium'>
                  Motor Circuit Analysis Level I
                </span>
              </div>
        ...
        <Card className='bg-gradient-to-r from-primary to-primary/80 p-12 text-center text-primary-foreground'>
          <CardContent>
            <h2 className='text-3xl font-bold mb-4'>
              Master Motor Circuit Analysis
            </h2>
            <p className='text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto'>
              Join thousands of professionals who have mastered motor circuit
              analysis and enhanced their electrical maintenance capabilities.
            </p>

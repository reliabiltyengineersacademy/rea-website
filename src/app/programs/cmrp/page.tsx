...
import { Award, CheckCircle, Clock, Users, BookOpen, ArrowRight, Star, Shield } from 'lucide-react';
  ...
  return (
    <div className="pt-20 min-h-screen bg-background">
              ...
              <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-2xl p-8">
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-primary-foreground/80">Certified Professionals</div>
                  </div>
                  <div className="text-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <Card className="p-8">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-muted-foreground">4-hour computer-based exam</span>
                </div>
                <div className="flex items-center">
                  <BookOpen className="h-5 w-5 text-primary mr-3" />
                  <span className="text-muted-foreground">300 multiple-choice questions</span>
                </div>
                <div className="flex items-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {eligibilityOptions.map((option, index) => (
              <Card key={index} className="p-8">
                <CardContent>
                  <h3 className="text-xl font-semibold text-foreground mb-6">{option.title}</h3>
        ...
        {/* Exam Domains */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-foreground mb-8">Exam Content Domains</h2>
          <div className="space-y-6">
            {examDomains.map((domain, index) => (
              <Card key={index} className="p-8">
                <CardContent>
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl font-semibold text-foreground">{domain.domain}</h3>
        ...
        {/* Course Structure */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-foreground mb-8">REA CMRP Preparation Course</h2>
          <Card className="bg-gradient-to-br from-primary/5 to-primary/10 p-12">
            <CardContent>
              <div className="grid lg:grid-cols-2 gap-12">
                <div>
                  <h3 className="text-2xl font-bold text-foreground mb-6">Comprehensive Preparation Program</h3>
                  ...
                  <p className="text-lg text-muted-foreground mb-6">
                    <strong>Lead Instructor:</strong> KVK Subramaniyam Naidu - Certified reliability expert with over 15 years of industry experience.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-primary mr-3" />
                      <span className="text-muted-foreground">40+ hours of comprehensive training</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-primary mr-3" />
                ...
                <Card className="bg-background p-8">
                  ...
                  <CardContent className="space-y-4">
                    <div className="border-l-4 border-primary pl-4">
                      <h5 className="font-semibold text-foreground">Module 1: Business & Management</h5>
                      <p className="text-muted-foreground text-sm">Strategic planning, leadership, and financial management</p>
                    </div>
                    <div className="border-l-4 border-primary pl-4">
                      <h5 className="font-semibold text-foreground">Module 2: Manufacturing Process Reliability</h5>
                      <p className="text-muted-foreground text-sm">Process optimization and quality systems</p>
                    </div>
                    <div className="border-l-4 border-primary pl-4">
                      <h5 className="font-semibold text-foreground">Module 3: Equipment Reliability</h5>
                      <p className="text-muted-foreground text-sm">Asset management and reliability engineering</p>
                    </div>
                    <div className="border-l-4 border-primary pl-4">
                      <h5 className="font-semibold text-foreground">Module 4: Work Management</h5>
                      <p className="text-muted-foreground text-sm">Planning, scheduling, and performance measurement</p>
                    </div>
                    <div className="border-l-4 border-primary pl-4">
                      <h5 className="font-semibold text-foreground">Module 5: Defect Elimination</h5>
                      <p className="text-muted-foreground text-sm">Root cause analysis and preventive maintenance</p>
                    </div>
                  </CardContent>
                </Card>
              </div>

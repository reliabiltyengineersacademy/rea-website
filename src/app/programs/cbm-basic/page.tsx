...
import {
  ...
  learningOutcomes,
} from '@/constants/programs/cbmBasic';
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <h1 className='text-4xl lg:text-5xl font-bold mb-6'>
                Condition Based Maintenance (CBM) For Plant Asset - Basic Level
              </h1>
        ...
        <Card className='bg-gradient-to-r from-primary to-primary/80 p-12 text-center text-primary-foreground'>
          <CardContent>
            <h2 className='text-3xl font-bold mb-4'>
              Master Condition Based Maintenance
            </h2>
            <p className='text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto'>
              Join thousands of professionals who have mastered CBM and
              transformed their maintenance strategies for better equipment

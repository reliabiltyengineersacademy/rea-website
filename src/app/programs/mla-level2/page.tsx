...
import {
  ...
  learningOutcomes,
} from '@/constants/programs/mlaLevel2';
            ...
            <div>
              <div className='inline-flex items-center bg-primary-foreground/20 rounded-full px-4 py-2 mb-6'>
                ...
                <span className='text-sm font-medium'>
                  ISO 18436-4 Level II
                </span>
              </div>

              <h1 className='text-4xl lg:text-5xl font-bold mb-6'>
                Machine Lubricant Analyst ISO Level II Training
              </h1>

              <p className='text-xl text-primary-foreground/90 mb-8 leading-relaxed'>
                Advance your lubricant analysis expertise with our ISO 18436-4
                Level II certification program. Master advanced analysis
                techniques, complex failure diagnosis, and program management.
              </p>

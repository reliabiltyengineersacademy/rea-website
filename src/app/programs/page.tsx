...
import { Award, Clock, Users, BookOpen, ArrowRight, Shield, TrendingUp, Search, Settings, Zap } from 'lucide-react';
...
export default function Programs() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-r from-primary/10 to-primary/20 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            ...
            designed by industry experts. Choose from our comprehensive range of professional development programs.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {programs.map((program) => (
            <Card key={program.id} className="group hover:shadow-xl hover:border-primary/30 transition-all duration-300 transform hover:-translate-y-1">
      ...
      <div className="bg-gradient-to-br from-primary/10 to-primary/20 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="p-8 md:p-12">
            <CardContent>
              <div className="text-center mb-12">
                <h2 className="text-4xl font-bold mb-4">Why Choose REA Certifications?</h2>

...
import {
  ...
  keyTopics,
  diplomaRequirements,
} from '@/constants/programs/diplomaReliabilityEngineering';
import { Badge } from '@/components/ui/badge';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';

const DiplomaReliabilityEngineering = () => {
  return (
    <div className='min-h-screen bg-background'>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
          ...
          <div className='grid lg:grid-cols-2 gap-12'>
            <div>
              <p className='text-lg text-muted-foreground mb-6 leading-relaxed'>
                The Diploma in Reliability Engineering is a comprehensive
                program designed to equip professionals with advanced knowledge
                and skills in reliability engineering principles, failure
                analysis, and system optimization. This diploma program covers
                all aspects of reliability engineering from fundamentals to
        ...
        <div className='mb-16'>
          <h2 className='text-3xl font-bold text-foreground mb-8'>
            REA Diploma in Reliability Engineering Program
          </h2>
              ...
              <div className='grid lg:grid-cols-2 gap-12'>
                <div>
                  <h3 className='text-2xl font-bold text-foreground mb-6'>
                    Comprehensive Reliability Engineering Education
                  </h3>
                  <p className='text-lg text-muted-foreground mb-6'>
                    Our Diploma in Reliability Engineering program provides
                    comprehensive training in all aspects of reliability
                    engineering, from fundamental principles to advanced
                    applications and real-world implementation.
                  </p>
                  <p className='text-lg text-muted-foreground mb-6'>
                    <strong>Lead Instructor:</strong> KVK Subramaniyam Naidu -
                    Senior reliability engineering consultant and expert with
                    extensive industry experience in failure analysis and system
                    optimization.
                  </p>
                  <ul className='space-y-3'>
                    ...
                    <li className='flex items-center'>
                      <CheckCircle className='h-5 w-5 text-primary mr-3' />
                      <span className='text-muted-foreground'>
                        Access to advanced reliability engineering tools
                      </span>
                    </li>
                    <li className='flex items-center'>
                      <CheckCircle className='h-5 w-5 text-primary mr-3' />
        ...
        <Card className='bg-gradient-to-r from-primary to-primary/80 p-12 text-center text-primary-foreground'>
          <CardContent>
            <h2 className='text-3xl font-bold mb-4'>
              Earn Your Diploma in Reliability Engineering
            </h2>
            <p className='text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto'>
              Join the ranks of certified reliability engineering professionals
              and advance your career with comprehensive expertise in failure
              analysis, system optimization, and risk management.
            </p>
...
export default DiplomaReliabilityEngineering;

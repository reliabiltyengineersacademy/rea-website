...
import { Award, CheckCircle, Clock, Users, BookOpen, ArrowRight, Eye, Thermometer, Zap, Shield } from 'lucide-react';
...
const InfraredThermography = () => {
  ...
  const targetAudience = [
    {
      ...
      description: "Professionals responsible for electrical system maintenance and inspection"
    },
    {
      title: "Maintenance Engineers",
      description: "Engineers overseeing facility maintenance and equipment reliability"
    },
    {
      title: "Building Inspectors",
      description: "Inspectors evaluating building envelope and energy efficiency"
    },
    {
      title: "Quality Assurance Personnel",
      description: "QA professionals using thermal imaging for process monitoring"
    }
  ];
  ...
  const certificationLevels = [
    {
      ...
      topics: ["Heat transfer theory", "Camera operation", "Basic analysis", "Safety procedures"],
      capabilities: [
    ...
    },
    {
      ...
      topics: ["Advanced analysis", "Report writing", "Program setup", "Standards compliance"],
      capabilities: [
  ...
  const applicationAreas = [
    {
      ...
      description: "Switchgear, transformers, motors, and electrical connections inspection",
      applications: ["Overheating connections", "Load imbalances", "Insulation defects", "Arc flash prevention"]
    },
    {
      icon: Thermometer,
      title: "Mechanical Systems",
      description: "Rotating equipment, bearings, and mechanical component analysis",
      applications: ["Bearing problems", "Belt misalignment", "Coupling issues", "Pump cavitation"]
    },
    {
      icon: Shield,
      title: "Building Envelope",
      description: "Insulation defects, air leakage, and moisture detection",
      applications: ["Insulation gaps", "Air infiltration", "Moisture intrusion", "Energy audits"]
    },
    {
      icon: Eye,
      title: "Process Monitoring",
      description: "Industrial process temperature monitoring and control",
      applications: ["Furnace monitoring", "Heat exchanger efficiency", "Process optimization", "Quality control"]
    }
  ];
  ...
  const industryStandards = [
    ...
    {
      standard: "ASTM E1934",
      description: "Standard guide for examining electrical and mechanical equipment"
    },
    {
      standard: "NETA MTS",
  ...
  return (
    <div className="pt-20 min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center bg-primary-foreground/20 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-medium">Level I & II Certification</span>
              </div>
              ...
              <p className="text-xl text-primary-foreground/90 mb-8 leading-relaxed">
                Master the science of thermal imaging with our comprehensive Level I & II 
                thermography certification program. Detect problems before they become failures 
                using non-contact inspection techniques.
              </p>
              ...
              <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-2xl p-8">
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-primary-foreground/80">Certified Thermographers</div>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-primary-foreground/80">Problem Detection Rate</div>
                  </div>
                  <div className="text-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Infrared thermography is a powerful non-destructive testing technique that uses 
                thermal imaging to detect temperature variations in equipment and structures. 
                Our certification program follows ASNT guidelines and industry standards.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                This comprehensive training covers both theoretical principles and practical 
                applications, preparing you to perform professional thermal inspections across 
            ...
            <Card className="p-8">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-muted-foreground">ASNT SNT-TC-1A Compliant</span>
                </div>
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-muted-foreground">Two-level certification path</span>
                </div>
                <div className="flex items-center">
        ...
        {/* Application Areas */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-foreground mb-8">Application Areas</h2>
        ...
        {/* Equipment Types */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-foreground mb-8">Equipment & Technology</h2>
          <Card className="p-8">
            <CardContent>
        ...
        {/* Industry Standards */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-foreground mb-8">Industry Standards</h2>
          <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="mb-16">
          ...
          <Card className="bg-gradient-to-br from-primary/5 to-primary/10 p-12">
            <CardContent>
              <div className="grid lg:grid-cols-2 gap-12">
                <div>
                  <h3 className="text-2xl font-bold text-foreground mb-6">Professional Thermography Training</h3>
                  <p className="text-lg text-muted-foreground mb-6">
                    Our program combines classroom instruction with extensive hands-on practice using 
                    professional-grade thermal imaging equipment and real-world inspection scenarios.
                  </p>
                  <p className="text-lg text-muted-foreground mb-6">
                    <strong>Lead Instructor:</strong> KVK Subramaniyam Naidu - Certified Level III thermographer with 15+ years of experience.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-primary mr-3" />
                      <span className="text-muted-foreground">Hands-on training with thermal cameras</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-primary mr-3" />
                      <span className="text-muted-foreground">Real-world inspection scenarios</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-primary mr-3" />
                    ...
                    <li className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-primary mr-3" />
                      <span className="text-muted-foreground">ASNT certification exam preparation</span>
                    </li>
                  </ul>
                </div>
                <Card className="bg-background p-8">
                  ...
                  <CardContent className="space-y-4">
                    <div className="border-l-4 border-primary pl-4">
                      <h5 className="font-semibold text-foreground">Thermal Cameras</h5>
                      <p className="text-muted-foreground text-sm">Professional-grade thermal imaging systems</p>
                    </div>
                    <div className="border-l-4 border-primary pl-4">
                      <h5 className="font-semibold text-foreground">Analysis Software</h5>
                      <p className="text-muted-foreground text-sm">Industry-standard thermal analysis tools</p>
                    </div>
                    <div className="border-l-4 border-primary pl-4">
                      <h5 className="font-semibold text-foreground">Test Targets</h5>
                      <p className="text-muted-foreground text-sm">Electrical panels, motors, and mechanical systems</p>
                    </div>
                    <div className="border-l-4 border-primary pl-4">
                      <h5 className="font-semibold text-foreground">Calibration Sources</h5>
                      <p className="text-muted-foreground text-sm">Blackbody sources and reference standards</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
        ...
        <Card className="bg-gradient-to-r from-primary to-primary/80 p-12 text-center text-primary-foreground">
          <CardContent>
            ...
            <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
              Master the art of thermal imaging and become a certified thermographer capable of 

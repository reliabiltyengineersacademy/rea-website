...
import {
  methodologies,
  deliverables,
} from '@/constants/our-services/reliabilityEngineering';
        ...
        <Container className='py-20'>
          <div className='text-center max-w-4xl mx-auto'>
            ...
            <p className='text-xl text-gray-700 dark:text-gray-300 mb-12 leading-relaxed'>
              REA specializes in the design and deployment of customized
              Reliability-Centered Maintenance (RCM) frameworks. Leveraging
              advanced methodologies to develop targeted maintenance strategies
              aligned with business KPIs, asset lifecycle goals, and operational
              constraints.
            </p>
      ...
      <Container className='py-16'>
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            <div>
              <h2 className='text-3xl font-bold text-foreground mb-6'>
                Strategic Maintenance Excellence
              </h2>
              <p className='text-lg text-muted-foreground mb-6 leading-relaxed'>
                Our reliability engineering services facilitate the transition
                from reactive to proactive and predictive maintenance,
                supporting long-term asset reliability and cost control. We
                develop strategies that align with your business objectives and
                operational constraints.
              </p>
              <p className='text-lg text-muted-foreground mb-8 leading-relaxed'>
                These strategies enable organizations to optimize maintenance
                resources, reduce unplanned downtime, and achieve sustainable
                operational excellence across complex industrial ecosystems.
              </p>
              <div className='flex flex-col sm:flex-row gap-4'>
                <Button className='px-6 py-3'>Schedule Consultation</Button>
                  ...
                  <div className='flex items-start'>
                    ...
                    <div>
                      ...
                      <p className='text-muted-foreground text-sm'>
                        Optimize maintenance spending through strategic planning
                      </p>
                    </div>
                  </div>
                  <div className='flex items-start'>
                    ...
                    <div>
                      ...
                      <p className='text-muted-foreground text-sm'>
                        Enhance equipment performance and longevity
                      </p>
                    </div>
                  </div>
                  <div className='flex items-start'>
                    ...
                    <div>
                      ...
                      <p className='text-muted-foreground text-sm'>
                        Identify and address potential failure modes proactively
                      </p>
                    </div>
                  </div>
                  <div className='flex items-start'>
        ...
        <div className='mb-20'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-muted-foreground max-w-3xl mx-auto'>
              We employ industry-leading methodologies and frameworks to deliver
              comprehensive reliability engineering solutions.
            </p>
          </div>
        ...
        <div className='mb-20'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-muted-foreground max-w-3xl mx-auto'>
              Our comprehensive approach ensures you receive actionable insights
              and practical solutions for immediate implementation.
            </p>
          </div>
            ...
            <CardContent>
              <div className='max-w-4xl mx-auto'>
                ...
                <p className='text-xl text-primary-foreground/90 leading-relaxed mb-8'>
                  Partner with REA to develop a comprehensive reliability
                  engineering framework that drives operational excellence and
